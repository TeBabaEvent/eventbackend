...
def serialize_event(db_event: models.Event) -> dict:
    ...
    return {
        ...
        "youtube_shorts_url": db_event.youtube_shorts_url,
        "instagram_reels_url": db_event.instagram_reels_url,
        "capacity": db_event.capacity,
        "status": db_event.status,
        "allowed_payment_methods": db_event.allowed_payment_methods,
        "bank_account_iban": db_event.bank_account_iban,
        "bank_account_name": db_event.bank_account_name,
        "bank_account_bic": db_event.bank_account_bic,
